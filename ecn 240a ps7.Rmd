...
#Summary
The results from our regressions are similar to those obtained in the Roberts-Schlenker paper. However, compared to the RS paper, our instrument appears \textbf{relatively weak for the supply estimate} and \textbf{relatively strong for the demand estimate.} This could be because the data we use are slightly different.
...
stargazer(supplyIV.area, supplyIV.yield, header = FALSE, keep = c("ln_fp","ln_w"), title = "Using Area or Yield for Supply")
```
#Question 5 and 6
